<html>
  <body>
    ...
    Annie and Dave would like to invite you to <?php print $_GET["EventName"]; ?>.<p/>
    ...
    Please let us know if you would like to attend or not by clicking on the appropriate icon below.<p/>
